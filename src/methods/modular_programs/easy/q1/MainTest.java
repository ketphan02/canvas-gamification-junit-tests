...
public class MainTest extends BaseTest {
  ...
  public Clause[] testSentence() {
    ...
    return new Clause[] {new StringLiteral("Please enter your height in cm: "),
                         new NewLine(), new PlaceHolder()};
  }

  public void runMain() { AverageHeight.main(new String[0]); }

  static Stream<Arguments> heightCheckerInputProvider() {
    return Stream.of(
        Arguments.of(170.0, "You're above the average height in Canada!" +
                                System.lineSeparator()),
        Arguments.of(168.7, "You're below the average height in Canada!" +
                                System.lineSeparator()),
        Arguments.of(168.70001, "You're above the average height in Canada!" +
                                    System.lineSeparator()),
        Arguments.of(-37, "Invalid input!" + System.lineSeparator()),
        Arguments.of(149.23716, "You're below the average height in Canada!" +
                                    System.lineSeparator()),
        Arguments.of(-0.0001, "Invalid input!" + System.lineSeparator()),
        Arguments.of(0, "You're below the average height in Canada!" +
                            System.lineSeparator()));
  }
  ...
  static Stream<Arguments> mainMethodInputProvider() {
    ...
    return Stream.of(
        ...
        Arguments.of(r.nextDouble() * 168.7,
                     "You're below the average height in Canada!"),
        Arguments.of(r.nextDouble() * 50 + 169,
                     "You're above the average height in Canada!"));
  }

  @ParameterizedTest
  @MethodSource("heightCheckerInputProvider")
  void correctHeightCheckerMethod(double height, String message)
      throws Throwable {
    MethodUtil.invokeIfMethodExists(AverageHeight.class, "heightChecker",
                                    new Object[] {height}, double.class);
  ...
  void correctUserInputMethod(double input) throws Throwable {
    ...
    Object output =
        MethodUtil.invokeIfMethodExists(AverageHeight.class, "userInput");
    CustomAssertions._assertEquals(
        input, output,
  ...
  void printsOutputCorrectly(double height, String message)
    ...
    runWithInput(String.valueOf(height),
                 new Clause[] {new StringLiteral(message)});
  }
}
